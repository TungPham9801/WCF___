...
namespace DAL_QLCP
{
    public class DBAccess
    {
        ...
        {
            //tùng : Data Source=DESKTOP-0Q9VVUT\SQLEXPRESS;Initial Catalog=QuanLiCaPhe;Integrated Security=True
            //sơn : Data Source=DESKTOP-K9B9VR3\SQLEXPRESS;Initial Catalog=QuanLiCaPhe;Integrated Security=True
            connect = new SqlConnection(@"Data Source=DESKTOP-0Q9VVUT\SQLEXPRESS;Initial Catalog=QuanLyCaPhe;Integrated Security=True");
            try
            {
                connect.Open();
                connect.Close();
